...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<% if(request.getSession().getAttribute("admin")==null) 
		...
		ResultSet rs = produit.getProduits();
	%>
											...
											<table>
												...
												<% while(rs.next()) { %>
													<tr class="row100 body">
														<td class="cell100 column1"><%= rs.getString("idProduit") %></td>
														<td class="cell100 column2"><%= rs.getString("nomProduit") %></td>
														<td class="cell100 column3"><%= rs.getString("prixProduit") %></td>				
														<td class="cell100 column4"><a href="/Projet/admin/modifierProduit.jsp?idProduit=<%= rs.getString("idProduit") %>"  class="btn btn-info" style="color:white"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
														<td class="cell100 column5"><a href="/Projet/Produit?idProduit=<%= rs.getString("idProduit") %>" class="btn btn-danger" style="color:white" ><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
													</tr>
												<% } %>
												</tbody>
											</table>
